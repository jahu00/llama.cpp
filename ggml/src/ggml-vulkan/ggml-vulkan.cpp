...
static bool ggml_vk_matmul_int_shmem_support(const vk_device& device, const std::vector<uint32_t>& warptile, bool mul_mat_id, ggml_type src0_type) {
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_Q6_0:    block_a_size = std430_size({{16, 4}, {8, 4}, {fp_size,  fp_align}});          break; // qs[16/4] + qh[8] + dm
...
#define CREATE_MM2(PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT) \
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_Q6_0], matmul_q6_0_f16, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3)
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q6_0], matmul_id_subgroup_q6_0_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        if (device->coopmat_acc_f16_support) {
            ...
            CREATE_MM2(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q6_0], matmul_q6_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            ...
            CREATE_MM(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q6_0].f32acc, matmul_q6_0_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
        ...
        CREATE_MM2(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q6_0], matmul_id_subgroup_q6_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        ...
        CREATE_MM2(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q6_0], matmul_q6_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM2(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q6_0], matmul_id_subgroup_q6_0_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM2(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q6_0], matmul_id_q6_0_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#define CREATE_MMQ(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        CREATE_MM(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q6_0].f32acc, matmul_q6_0_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q6_0].f32acc, matmul_id_subgroup_q6_0_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM(GGML_TYPE_Q6_0, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q6_0].f32acc, matmul_id_q6_0_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#undef CREATE_MM
    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_Q6_0][i], "mul_mat_vec_q6_0_f32_f32", arr_dmmv_q6_0_f32_f32_len[reduc], arr_dmmv_q6_0_f32_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_stdq, 1, 1}, {wg_size_subgroup, 2*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_Q6_0][i], "mul_mat_vec_q6_0_f16_f32", arr_dmmv_q6_0_f16_f32_len[reduc], arr_dmmv_q6_0_f16_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_stdq, 1, 1}, {wg_size_subgroup, 2*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_Q6_0], "mul_mat_vec_id_q6_0_f32",       arr_dmmv_id_q6_0_f32_f32_len[reduc],    arr_dmmv_id_q6_0_f32_f32_data[reduc],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {2*rm_stdq, 1, 1}, {wg_size_subgroup, 2*rm_stdq}, 1, true, use_subgroups, force_subgroup_size);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_Q6_0], "dequant_q6_0", dequant_q6_0_len, dequant_q6_0_data, "main", 2, 5 * sizeof(uint32_t), {256 * 16, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_cpy_f32_quant[GGML_TYPE_Q6_0], "cpy_f32_q6_0", cpy_f32_q6_0_len, cpy_f32_q6_0_data, "main", 2, sizeof(vk_op_unary_push_constants), {32, 1, 1}, {}, 1);
...
#undef SET_ROWS
    ...
    ggml_vk_create_pipeline(device, device->pipeline_cpy_quant_f32[GGML_TYPE_Q6_0], "cpy_q6_0_f32", cpy_q6_0_f32_len, cpy_q6_0_f32_data, "main", 2, sizeof(vk_op_unary_push_constants), {(uint32_t)ggml_blck_size(GGML_TYPE_Q6_0), 1, 1}, {}, 1);
